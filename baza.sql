...
('awd',1,2,10000,1,'awd'),
('fwd',1,2,12000,1,'fwd'),
('#0e0e0e',1,3,2000,1,'Czarny to synonim uniwersalnoœci, a zarazem elegancja'),
('#b2b2b2',1,3,2000,1,'Srebrny to synonim dostatku i presti¿u'),
('#939393',1,3,2000,1,'Szary to rozwaga i ostro¿noœæ'),
('#32CD32',1,3,2000,1,'Jeœli przywi¹zujesz wagê do walorów estetycznych ten kolor jest dla Ciebie!'),
('#ffff33',1,3,2000,1,'Jesteœ ³owc¹ przygód? ¯ó³y to jest to!'),
('#ff0033',1,3,3000,1,'Lubisz wyró¿niaæ siê w t³umie? Ten kolor jest idealny dla Ciebie!'),
